...
},{"./bundle-url":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./fonts\\SignikaNegative-Bold.ttf":[["SignikaNegative-Bold.78138db3.ttf","fonts/SignikaNegative-Bold.ttf"],"fonts/SignikaNegative-Bold.ttf"],"./fonts\\SignikaNegative-Light.ttf":[["SignikaNegative-Light.1745eba8.ttf","fonts/SignikaNegative-Light.ttf"],"fonts/SignikaNegative-Light.ttf"],"./fonts\\SignikaNegative-Regular.ttf":[["SignikaNegative-Regular.8ca8c012.ttf","fonts/SignikaNegative-Regular.ttf"],"fonts/SignikaNegative-Regular.ttf"],"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/nchan/NchanSubscriber.js":[function(require,module,exports) {
var global = arguments[3];
var define;
/*
 * NchanSubscriber
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"node_modules/micromodal/dist/micromodal.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"modal.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _nchan = _interopRequireDefault(require("nchan"));
...
var sub = new _nchan.default('https://server.igniteonline.net/api/live/nowplaying/ignite');
var count;
...
sub.on("message", function (message, message_metadata) {
  ...
  if (nowPlaying.now_playing.streamer !== "") {
    ...
    if ([nowPlaying.now_playing.song.album, artist] !== storedsearch) {
      ...
      _axios.default.get("".concat(backendURL, "album?albumname=").concat(storedsearch[0], "&artistname=").concat(storedsearch[1])).then(function (_ref) {
        var data = _ref.data;
        $(".art").attr("src", data);
      }).catch(function (data) {
...
sub.on('connect', function (evt) {//fired when first connected.
});
sub.start();
...
var setCountdown = function setCountdown() {
  ...
  var composited = "".concat(days, " Days ").concat(hours, " Hours ").concat(minutes, " Minutes ").concat(seconds, " Seconds");
  $(".countdown").text(composited); // $("title").text("IGNITE " + composited)
};
...
$(".slider").on("input", function (data) {
  $("#audio")[0].volume = data.target.value / 100;
});

_micromodal.default.init();
},{"./main.scss":"main.scss","jquery":"node_modules/jquery/dist/jquery.js","nchan":"node_modules/nchan/NchanSubscriber.js","axios":"../node_modules/axios/index.js","micromodal":"node_modules/micromodal/dist/micromodal.es.js","./modal.css":"modal.css"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
